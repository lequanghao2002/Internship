...
namespace BNI.Migrations
{
    ...
    [Migration("20240322025328_Events")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BNI.Models.Domain.EventTitle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BNI.Models.Domain.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "1a9c1392-acd7-40e5-a785-31ac3e8be002",
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            ConcurrencyStamp = "c4f8f358-eafb-45df-b8ca-5e8be0c28314",
                            Name = "User"
                        },
                        new
                        {
                            Id = 3,
                            ConcurrencyStamp = "4e2ca6f1-8c69-44a1-ab1a-147677942e31",
                            Name = "Member"
                        });
                });
            ...
            modelBuilder.Entity("BNI.Models.Domain.TitleImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EventTitleId");

                    b.ToTable("TitleImage");
                });
            ...
            modelBuilder.Entity("BNI.Models.Domain.EventTitle", b =>
                {
                    b.HasOne("BNI.Models.Domain.Events", "Event")
                        .WithMany("EventTitles")
            ...
            modelBuilder.Entity("BNI.Models.Domain.TitleImage", b =>
                {
                    b.HasOne("BNI.Models.Domain.EventTitle", "EventTitle")
                        .WithMany("TitleImages")
                        .HasForeignKey("EventTitleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BNI.Models.Domain.Category_Support", b =>
                {
                    b.Navigation("Business_Support");
                });

            modelBuilder.Entity("BNI.Models.Domain.Events", b =>
                {
                    b.Navigation("EventTitles");
